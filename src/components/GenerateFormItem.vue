<template>
  <el-form-item :label="widget.name" :prop="widget.model">
    ...
    <template v-if="widget.type=='myImgupload'">
      <fm-ada-img-upload
              v-model="dataModel"
              :disabled="widget.options.disabled"
              :style="{'width': widget.options.width}"
...
<script>
    ...
    import FmFileUpload from './FileUpload'
    import FmAdaImgUpload from './AdaImgUpload'
...
export default {
  ...
  created () {
    ...
    if (this.widget.type === 'imgupload') {
      ...
      if (this.widget.type === 'myImgupload') {

      }
      if (this.widget.type === 'fileupload') {

          //console.info("this.widget======fileupload===="+JSON.stringify(this.widget))
      }
  },
  watch: {
    dataModel: {
